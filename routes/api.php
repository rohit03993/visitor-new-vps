...
Route::middleware(['web'])->group(function () {
    ...
    Route::post('/notifications/store-fcm-token', [App\Http\Controllers\PushNotificationController::class, 'storeFCMToken'])->name('api.notifications.store-fcm-token'); // Added
});
