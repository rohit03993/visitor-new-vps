...
@section('title', "Today's Interactions - VMS")
...
<div class="row mb-3">
    <div class="col-12">
        <div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center gap-2 mb-3">
            <div>
                <small class="text-muted">{{ $interactions->total() }} interactions today ({{ \App\Helpers\DateTimeHelper::formatIndianDate(now()) }})</small>
            </div>
    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                <h5 class="mb-0">
                    <i class="fas fa-calendar-day me-2"></i>Today's Interactions
                </h5>
            </div>
            <div class="card-body">
                        ...
                        <table class="table table-hover">
                            ...
                            <tbody>
                                @foreach($interactions as $interaction)
                                    <tr>
                                        <td>
                                            <strong>{{ \App\Helpers\DateTimeHelper::formatIndianTime($interaction->created_at) }}</strong>
                                        </td>
                                        <td>
                                            <div>
                ...
                @else
                    <div class="text-center py-4">
                        ...
                        <h5 class="text-muted">No interactions today</h5>
                        <p class="text-muted">No interactions have been recorded for today yet.</p>
                    </div>
                @endif
            </div>
        </div>
