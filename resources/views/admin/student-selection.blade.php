...
@section('title', 'Select Student - Admin Panel')
        ...
        <div class="card-paytm paytm-fade-in">
            ...
            <div class="card-paytm-body">
                ...
                <div class="back-to-search-section">
                    ...
                    <div class="back-to-search-option" onclick="backToSearch()">
                        <div class="back-to-search-content">
                            <i class="fas fa-arrow-left me-3"></i>
                            <div>
                                <h6>Back to Search</h6>
                                <small class="text-muted">Search for a different phone number</small>
                            </div>
                        </div>
                        <div class="selection-arrow">
                            <i class="fas fa-chevron-right"></i>
...
.back-to-search-content i {
    color: #6c757d;
    font-size: 1.5rem;
}

.back-to-search-content h6 {
    margin: 0;
    color: #2c3e50;
}
...
function selectStudent(visitorId) {
    ...
    window.location.href = "{{ route('admin.visitor-profile', '') }}/" + visitorId;
}

function backToSearch() {
    // Redirect back to search form
    window.location.href = "{{ route('admin.search-mobile') }}";
}

// Add keyboard navigation
document.addEventListener('keydown', function(e) {
    const options = document.querySelectorAll('.student-option, .back-to-search-option');
    let currentIndex = -1;
